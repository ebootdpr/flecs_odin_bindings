...
// @(default_calling_convention = "c", link_prefix = "ecxds_", private)
// foreign flecs
// {
...
// @(default_calling_convention = "c", link_prefix = "ecsxd_")
// foreign flecs
// {
   
//     vec_free :: proc(vec: ^Vec) ---
//     // Clear values in vec
//     vec_clear :: proc(vec: ^Vec) ---
//     // Assert when the provided size does not match the vec type
//     vec_assert_size :: proc(vec_inout: ^Vec, size: size_t) ---
